"""
Django settings for leaderboard_microservice project.
...
ROOT_URLCONF = 'leaderboard_microservice.urls'
...
WSGI_APPLICATION = 'leaderboard_microservice.wsgi.application'
